...
public class KafkaConsumerMessage : BackgroundService
{
    ...
    {       
        ...
        using var consumer = new ConsumerBuilder<string, MessageData>(_config)
            .SetKeyDeserializer(Deserializers.Utf8)
            .SetValueDeserializer(SchemaRegistryService.GetDeserializer().AsSyncOverAsync())
            .Build();
        ...
        try
        {
            ...
            while (true)
            {
                ...
                var data = JsonConvert.DeserializeObject(messageData.Message, commandType) ?? new object();
